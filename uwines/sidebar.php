...
<section class="navigation">
    <span class="mobile-close-btn" id="menu-close-btn">
  ...
  <section class="top-right-part">
    <a href="#" class="trp-icon trp-icon_menu" id="mob-menu-btn">
      Меню
    </a>
    <a href="<?php echo get_permalink(get_option('woocommerce_cart_page_id')); ?>" class="trp-icon">
