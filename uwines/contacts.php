...
<div class="main-container" id="barba-wrapper">
  ...
  <section class="top-right-part">
   ...
   <section class="content barba-container">
    <div class="content-container content-container_contacts">
      <h2 class="main-h2">КОНТАКТЫ</h2>

      <div class="contacts-items-list">

   <?php $loop = new WP_Query( array( 'post_type' => 'contacts') );?>
       <?php while ( $loop->have_posts() ) : $loop->the_post(); ?>

        <div class="contact-item">
          <div class="contact-item-img">
            <img src="<?php bloginfo('template_directory'); ?>/img/icons/phone-reciever.svg" alt="">
          </div>
          <span class="contact-item-h"><?php echo get_post_meta(get_the_ID(), 'wpcf-text', true); ?></span>
          <a href="<?php echo get_post_meta(get_the_ID(), 'wpcf-prod-img', true); ?>" class="contact-item-link"><?php echo get_post_meta(get_the_ID(), 'wpcf-phone', true); ?></a>
        </div>
