  ...
  <section class="content barba-container">
    <div class="content-container content-container_open">
      ...
      <div class="box-desc-container">
        ...
        <h2 class="main-h2">
          Ящик
          <span class="thin">вина</span>
        </h2>

        <p class="bd-text">
          <span class="thin">
            Сет для ленивых выходных, за городом и не только
          </span>
        </p>
        ...
        <div class="bd-elements">
          <span class="bd-price">
            <span id="price">2250</span> грн
          </span>
          <a href="" class="def-btn def-btn_bd def-btn_shadow">Купить</a>
        ...
        <ul class="product-icons-list" id="icons-slider">
